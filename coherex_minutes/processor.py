...
SECTION_SPECS: dict[str, SectionSpec] = {
    ...
    "main_items": SectionSpec(
        "البنود الرئيسية",
        "المطلوب الآن قسم «البنود الرئيسية» فقط. لكل بند اكتب سطراً يبدأ برقم "
        "البند ونقطة ثم عنوان البند نفسه بين نجمتين، ثم فقرة من جملتين إلى أربع "
        "جمل تحته مباشرةً. اكتب عنوان البند الحقيقي المأخوذ من الملاحظات، ولا "
        "تكتب كلمة «عنوان» ولا أي نص نموذجي. "
        "اذكر في كل فقرة ما قيل فعلاً: الوقائع والأرقام والأسماء والإجراءات كما "
        "وردت، دون إعادة صياغة العنوان داخل فقرته، ودون تكرار الصياغة نفسها في "
        "أكثر من بند. لا تستخدم شرطات ولا نقاطاً، ولا تُعِد جدول الأعمال كقائمة.",
        900,
    ),
}
