...
SECTION_SPECS: dict[str, SectionSpec] = {
    ...
    "main_items": SectionSpec(
        "البنود الرئيسية",
        "المطلوب الآن قسم «البنود الرئيسية» فقط. اتبع هذا الشكل بالضبط لكل بند:\n"
        "**1. عنوان البند**\n"
        "فقرة من جملتين إلى أربع جمل.\n\n"
        "**2. عنوان البند التالي**\n"
        "فقرة من جملتين إلى أربع جمل.\n\n"
        "لا تستخدم شرطات ولا نقاطاً في هذا القسم، والعنوان دائماً بين نجمتين "
        "ومسبوق برقم ونقطة. اذكر في كل فقرة ما قيل فعلاً: الوقائع والأرقام "
        "والأسماء والإجراءات كما وردت، دون إعادة صياغة عنوان البند داخل فقرته، "
        "ودون تكرار الصياغة نفسها في أكثر من بند. لا تُعِد جدول الأعمال كقائمة.",
        900,
    ),
}
